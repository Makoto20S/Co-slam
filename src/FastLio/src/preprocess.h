...
typedef pcl::PointXYZI DiscoType;
...
POINT_CLOUD_REGISTER_POINT_STRUCT (LwType,
    (short int, x, x) (short int, y, y) (short int, z, z)
)
...
// clang-format off
POINT_CLOUD_REGISTER_POINT_STRUCT(ouster33_ros::Point,
    (float, x, x)
    (float, y, y)
    (float, z, z)
    (float, intensity, intensity)
